...
class __TwigTemplate_0f571a7f40d25a800dcb6c0a970dc3cc extends Template
{
...
\t\t\t\t\t\t\t<a href=\"";
        ...
        yield "\" class=\"dropdown-item\">Event_Manage</a>

\t\t\t\t\t   <!-- Show \"Manage Events\" only for Admin -->
\t\t\t\t\t\t\t<a href=\"";
        // line 96
        ...
        if (CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 111, $this->source); })()), "user", [], "any", false, false, false, 111)) {
            ...
            yield "                    <div class=\"nav-item dropdown\">
                        <a href=\"#\" class=\"nav-link dropdown-toggle\" data-bs-toggle=\"dropdown\">
                            <span>Welcome, ";
            // line 114
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 114, $this->source); })()), "user", [], "any", false, false, false, 114), "nom", [], "any", false, false, false, 114), "html", null, true);
            yield "</span>
                        </a>
                        <div class=\"dropdown-menu m-0\">
...
";
    ...
    {
        return array (  808 => 571,  802 => 568,  798 => 567,  794 => 566,  790 => 565,  784 => 563,  771 => 562,  619 => 420,  590 => 394,  561 => 368,  482 => 292,  478 => 291,  444 => 260,  408 => 227,  363 => 185,  355 => 180,  323 => 151,  309 => 140,  293 => 126,  288 => 124,  283 => 123,  275 => 118,  268 => 114,  264 => 112,  262 => 111,  249 => 101,  244 => 99,  238 => 96,  232 => 93,  221 => 85,  210 => 77,  146 => 15,  133 => 14,  120 => 11,  116 => 10,  112 => 9,  108 => 8,  103 => 7,  90 => 6,  66 => 3,  43 => 1,);
    }
...
\t\t\t<div class=\"collapse navbar-collapse\" id=\"navbarCollapse\">
\t\t\t\t<div class=\"navbar-nav ms-auto py-0\">
                    <a href=\"{{ path('app_admin') }}\" class=\"nav-item nav-link active\">Home</a>
                    <a href=\"#\" class=\"nav-item nav-link\">About</a>
                    <a href=\"#\" class=\"nav-item nav-link\">Service</a>
                    <div class=\"nav-item dropdown\">
                        <a href=\"#\" class=\"nav-link\" data-bs-toggle=\"dropdown\">
                        ...
                        <div class=\"dropdown-menu m-0\">
\t\t\t\t\t\t\t<a href=\"{{ path('app_user_index') }}\" class=\"dropdown-item\">Event_Manage</a>

\t\t\t\t\t   <!-- Show \"Manage Events\" only for Admin -->
\t\t\t\t\t\t\t<a href=\"{{ path('admin_evenements') }}\" class=\"dropdown-item\">Event_Manage</a>
\t\t\t\t\t\t\t 
 
 \t\t\t\t\t\t\t <a href=\"{{ path('admin_bookings_list') }}\" class=\"dropdown-item\"> Manage_reservation</a>

\t\t\t\t\t\t\t <a href=\"{{ path('admin_paid_bookings') }}\" class=\"dropdown-item\">Payment management </a>
...
\t</script>
{% endblock %}
", "home/admin.html.twig", "C:\\Users\\Cyrine\\Desktop\\MeetNtrip.tn\\projectPidev-main\\templates\\home\\admin.html.twig");
    }
}
