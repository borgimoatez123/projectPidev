 ...
 */
class getEmployeeEventAssignmentsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\Gestion_evenement\EmployeeEventAssignmentsRepository' shared autowired service.
     *
     * @return \App\Repository\Gestion_evenement\EmployeeEventAssignmentsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'Gestion_evenement'.\DIRECTORY_SEPARATOR.'EmployeeEventAssignmentsRepository.php';

        return $container->privates['App\\Repository\\Gestion_evenement\\EmployeeEventAssignmentsRepository'] = new \App\Repository\Gestion_evenement\EmployeeEventAssignmentsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
