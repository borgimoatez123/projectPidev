 ...
 */
class getFlightRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\gestion_de_reservation\FlightRepository' shared autowired service.
     *
     * @return \App\Repository\gestion_de_reservation\FlightRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'gestion_de_reservation'.\DIRECTORY_SEPARATOR.'FlightRepository.php';

        return $container->privates['App\\Repository\\gestion_de_reservation\\FlightRepository'] = new \App\Repository\gestion_de_reservation\FlightRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
