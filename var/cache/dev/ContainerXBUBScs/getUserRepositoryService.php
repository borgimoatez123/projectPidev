...
{
    /**
     * Gets the private 'App\Repository\gestion_user\UserRepository' shared autowired service.
     *
     * @return \App\Repository\gestion_user\UserRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'gestion_user'.\DIRECTORY_SEPARATOR.'UserRepository.php';

        return $container->privates['App\\Repository\\gestion_user\\UserRepository'] = new \App\Repository\gestion_user\UserRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
